...
local function bootstrap()
    ...
    local space1 = box.schema.create_space('limbo')
    space1:format({{name='mail',type='string'},
    {name='guid', type='string'}})
    space1:create_index('primary',{parts={'mail'}})
    space1:create_index('secondary',{parts={'guid'}})
